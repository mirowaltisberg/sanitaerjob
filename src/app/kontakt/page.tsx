...
export const metadata: Metadata = {
  ...
  description:
    "Kontaktmöglichkeit für Fragen und Hinweise zu sanitaerjobs.ch.",
  alternates: {
    canonical: "/kontakt",
  },
  openGraph: {
    title: "Kontakt & Support | sanitaerjobs.ch",
    description: "Kontaktmöglichkeit für Fragen und Hinweise zu sanitaerjobs.ch.",
    url: "/kontakt",
    type: "website",
  },
  twitter: {
    ...
    <div className="min-h-screen bg-slate-50 flex flex-col">
      ...
      <main id="main-content" className="flex-1 container mx-auto px-4 sm:px-6 py-12 sm:py-16 max-w-lg">
        ...
        <p className="text-slate-600 mb-6 leading-relaxed">
          Haben Sie eine Frage oder einen Hinweis zu sanitaerjobs.ch? Schreiben
