...
export const metadata: Metadata = {
  ...
  description:
    "Wer hinter den redaktionellen Inhalten von sanitaerjobs.ch steht: Recherche, Quellen, Methodik und unser Anspruch an Schweizer Lohn- und Branchendaten der Sanitär- und Gebäudetechnikbranche.",
  alternates: {
    canonical: "/team",
    ...
    <div className="min-h-screen bg-slate-50 flex flex-col">
      ...
      <main className="flex-1 container mx-auto px-4 sm:px-6 py-8 sm:py-12 max-w-3xl">
        ...
        <p className="text-slate-600 mt-3 text-base sm:text-lg leading-relaxed">
          Die Redaktion von sanitaerjobs.ch erstellt redaktionelle Inhalte zu Berufen,
          Löhnen und regionalen Arbeitsmärkten in der Schweizer Sanitär-, Heizungs-
          und Gebäudetechnikbranche.
        </p>
        ...
        <section className="mt-10 space-y-6">
          <article>
            ...
            <p className="text-slate-600 text-sm sm:text-base leading-relaxed">
              ...
              Stellenanzeigen aus der Schweizer Sanitär- und Gebäudetechnikbranche
              und sollen Sanitär-Fachkräften eine schnelle, ehrliche
          ...
          <article>
            ...
            <p className="text-slate-600 text-sm sm:text-base leading-relaxed">
              ...
              der Schweizer Sanitär- und Gebäudetechnikbranche — insbesondere{" "}
              <a
              ...
              (Schweizerisch-Liechtensteinischer Gebäudetechnikverband) sowie
              dem{" "}
              <a
              ...
              Stellenausschreibungen aus, die auf sanitaerjobs.ch indexiert sind.
              Die ausgewiesenen Lohnbänder sind Richtgrössen — der konkrete Lohn
          ...
          <article>
            ...
            <p className="text-slate-600 text-sm sm:text-base leading-relaxed">
              Inserate werden auf sanitaerjobs.ch grundsätzlich anonymisiert
