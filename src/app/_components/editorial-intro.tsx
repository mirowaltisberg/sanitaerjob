...
import type { EditorialContent } from "@/data/editorial/sanitaerjob";
import { EDITORIAL_BYLINE } from "@/data/editorial/sanitaerjob";

interface EditorialIntroProps {
  /** Display label for the role, e.g. "Sanitärinstallateur EFZ" */
  role: string;
