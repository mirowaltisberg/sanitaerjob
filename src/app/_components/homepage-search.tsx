...
function NativeDialog({ open, onOpenChange, titleId, descriptionId, compact = false, children }: {
  ...
  return (
    <dialog
      ref={dialogRef}
      className={`trade-native-dialog ${compact ? "trade-native-dialog--compact" : ""}`}
    ...
    >
      <button
        type="button"
        className="absolute right-3 top-3 grid h-11 w-11 place-items-center text-2xl text-muted-foreground hover:text-foreground"
            ...
            <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-3 mb-5">
              <div>
                ...
                <h2 className="text-2xl sm:text-3xl font-black text-foreground">
                  {hasSearched ? "Passende Sanitärstellen" : "Aktuelle Sanitärstellen"}
                </h2>
                {hasActiveLocation && (
